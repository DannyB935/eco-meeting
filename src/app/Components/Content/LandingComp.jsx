    ...
    <div className="flex-grow">
      <main>
        <div className="flex flex-col justify-center items-center">
          <div className="container flex flex-col md:grid md:grid-cols-6 bg-slate-100 w-full md:h-94 md:my-8 my-4 rounded-lg shadow-xl transform transition-transform duration-500 hover:scale-105 hover:cursor-pointer hover:shadow-2xl">
            <div className="col-span-2 md:h-full">
              <img src="./img/sticky-notes.jpg" alt="Seccion tips" className="rounded-md"/>
            </div>
            <div className="flex flex-col items-center justify-center p-4 col-span-4">
